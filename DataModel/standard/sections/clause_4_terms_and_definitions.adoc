...
=== project
context in which needs and requirements are originated. Datasets and their requirements are derived from the scope and objectives of a project and condition the feasibility of the results of the project.
