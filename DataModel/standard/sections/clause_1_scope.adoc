== Scope
This OGC Standard defines a data model for encoding needs and user requirements for capturing observations. This version of the GONAR Standard. A set of information classes is defined. $$$$$
