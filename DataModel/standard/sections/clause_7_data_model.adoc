...
A data requirement is characterized by the thematic variable captured, the coordinated measurements, the update frequency, the delivery timelines, the horizontal and vertical resolutions, its distribution in space and the data access mechanism.
