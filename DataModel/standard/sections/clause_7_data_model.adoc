...
4+| ^a^ GONAR proposes to use the Essential Variables framework defined by Lehmann et al in 2020 (10.1080/17538947.2019.1636490) to classify the requirements thematically. Thus, each variable to be measured must be associated to their respective class.
|===
