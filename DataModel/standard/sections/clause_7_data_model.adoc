...
|description | Brief narrative description of the project, normally for display to a human. | Character String type, not empty |  Zero or one (optional)
|logo | URL of the project logo. | Character String type, not empty |  Zero or one (optional)
|URL | Project URL. | Character String type, not empty |  Zero or one (optional)
|===
